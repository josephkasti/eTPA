...
L_list   = [100, 200, 300, 400, 500]*1e-3;  
...
for jj = 1:numel(L_list)
    ...
    plot(w0_sweep*1e6, P2_vs_w0*1e3, 'LineWidth',1.5, 'Color',colors(jj,:));
end
xlabel('w_0 (mm)');
% ylabel('P_{2\omega} (μW)');
ylabel('P_{2\omega} (mW)');
legend('L=100 mm','L=200 mm','L=300 mm','L=400 mm','L=500 mm', 'Location','NorthEast');
